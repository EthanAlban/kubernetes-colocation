...
func (in *KeepJobSpec) DeepCopyInto(out *KeepJobSpec) {
	*out = *in
	...
	in.CreatingTime.DeepCopyInto(&out.CreatingTime)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeepjobGroup) DeepCopyInto(out *KeepjobGroup) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeepjobGroup.
func (in *KeepjobGroup) DeepCopy() *KeepjobGroup {
	if in == nil {
		return nil
	}
	out := new(KeepjobGroup)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *KeepjobGroup) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeepjobGroupList) DeepCopyInto(out *KeepjobGroupList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]KeepjobGroup, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeepjobGroupList.
func (in *KeepjobGroupList) DeepCopy() *KeepjobGroupList {
	if in == nil {
		return nil
	}
	out := new(KeepjobGroupList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *KeepjobGroupList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeepjobGroupSpec) DeepCopyInto(out *KeepjobGroupSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeepjobGroupSpec.
func (in *KeepjobGroupSpec) DeepCopy() *KeepjobGroupSpec {
	if in == nil {
		return nil
	}
	out := new(KeepjobGroupSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeepjobGroupStatus) DeepCopyInto(out *KeepjobGroupStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeepjobGroupStatus.
func (in *KeepjobGroupStatus) DeepCopy() *KeepjobGroupStatus {
	if in == nil {
		return nil
	}
	out := new(KeepjobGroupStatus)
	in.DeepCopyInto(out)
	return out
}
