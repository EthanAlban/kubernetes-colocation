...
import (
	...
	versioned "colocation_backend/generated/node/clientset/versioned"
	internalinterfaces "colocation_backend/generated/node/informers/externalversions/internalinterfaces"
	v1 "colocation_backend/generated/node/listers/node/v1"
	"context"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.InfraV1().Nodes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InfraV1().Nodes(namespace).Watch(context.TODO(), options)
			},
		},
		&nodev1.Node{},
		resyncPeriod,
...
func (f *nodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nodev1.Node{}, f.defaultInformer)
}
