	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.InfraV1().VirtualNodes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InfraV1().VirtualNodes(namespace).Watch(context.TODO(), options)
			},
		},
		&infrav1.VirtualNode{},
		resyncPeriod,
...
func (f *virtualNodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&infrav1.VirtualNode{}, f.defaultInformer)
}

func (f *virtualNodeInformer) Lister() v1.VirtualNodeLister {
	return v1.NewVirtualNodeLister(f.Informer().GetIndexer())
}
