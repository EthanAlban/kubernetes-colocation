...
// KeepQueueInformer provides access to a shared informer and lister for
// KeepQueues.
type KeepQueueInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1.KeepQueueLister
}
...
func (f *keepQueueInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&infrav1.KeepQueue{}, f.defaultInformer)
}

func (f *keepQueueInformer) Lister() v1.KeepQueueLister {
	return v1.NewKeepQueueLister(f.Informer().GetIndexer())
}
